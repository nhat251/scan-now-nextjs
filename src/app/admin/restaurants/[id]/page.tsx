...
import { RestaurantDetailView } from "@/components/admin/restaurant-detail-view";
...
export default function AdminRestaurantDetailPage({ params }: AdminRestaurantDetailPageProps) {
  const { id } = use(params);

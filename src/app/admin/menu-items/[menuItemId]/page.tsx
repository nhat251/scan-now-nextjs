...
import { MenuItemDetailView } from "@/components/admin/menu-item-detail-view";
...
type AdminMenuItemDetailPageProps = {
  params: Promise<{ menuItemId: string }>;
};

export default function AdminMenuItemDetailPage({ params }: AdminMenuItemDetailPageProps) {
